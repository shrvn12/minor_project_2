...
// Middleware that helps with the property validation, if the test passes, next 
//function in the row will be invoked, otherwise, the server responds with 422 
// status and JSON object with a list of errors.
