...
home :  (req, res) => {
  ...
  res.render('dashboard/index0');
},

// homes action call it from login succsess action 
homes: async (req, res) => {

   console.log("Estoy en homes - linea 23");

    // def. obj queryString
    let queryString = {};

    // def. obj lookUpProduct
    ...
    // def. var sales 
    // model.agregate mongo function Aggregation operations are expressions you can use to produce // 
    // reduced and summarized results in MongoDB
    ...
    // got req.session.user in login action , that calls this action from
    // usersController line 221
    
    currentUser = req.session.user;
    user = req.session.user;

    console.log("Estoy en homes - linea 182 - voy hacia dasboard/index");
